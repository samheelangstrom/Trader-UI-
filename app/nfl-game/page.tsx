        ...
        <div className="max-w-7xl mx-auto p-4">
                    ...
                    <table className="w-full text-sm">
                      <tbody>
                        {alerts.map((alert) => (
                          <tr
                            key={alert.id}
                            className="border-b border-[#dcdddf] hover:bg-[#f9f9f9]"
                          >
            ...
            {expandedMarketClass && (
              <div className="mt-4 border border-[#dcdddf] rounded-md overflow-hidden">
                <div className="p-2 bg-[#2b2c2d] text-white text-sm font-medium flex justify-between items-center">
                  ...
                  <button
                    onClick={() => setExpandedMarketClass(null)}
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      <tr>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <MarketConfidenceSelector marketId="nfl.1234.moneyline.home" />
                        </td>
                      </tr>
                      <tr className="bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <MarketConfidenceSelector marketId="nfl.1234.moneyline.away" />
                        </td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      <tr>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <MarketConfidenceSelector marketId="nfl.1234.spread.home" />
                        </td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <MarketConfidenceSelector marketId="nfl.1234.spread.away" />
                        </td>
                      </tr>
                    </tbody>
                  </table>
          ...
          <div className="border border-[#dcdddf] rounded-md mb-4 overflow-hidden">
            ...
            >
              <div className="flex items-center">
                <ChevronDown
                  className={`h-4 w-4 mr-2 transition-transform ${!expandedSections.total ? "-rotate-90" : ""}`}
                />
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      <tr>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <MarketConfidenceSelector marketId="nfl.1234.total.over" />
                        </td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <MarketConfidenceSelector marketId="nfl.1234.total.under" />
                        </td>
                      </tr>
                    </tbody>
                  </table>
          ...
          <div className="border border-[#dcdddf] rounded-md mb-4 overflow-hidden">
            ...
            >
              <div className="flex items-center">
                <ChevronDown
                  className={`h-4 w-4 mr-2 transition-transform ${!expandedSections.passing ? "-rotate-90" : ""}`}
                />
                <span className="font-medium">Dak Prescott Passing Yards</span>
              </div>
            </div>
            {expandedSections.passing && (
              <div className="p-3">
                <MarketConfidenceSelector marketId="nfl.dak.passing" />
              </div>
            )}
          </div>
          ...
          <div className="border border-[#dcdddf] rounded-md mb-4 overflow-hidden">
            ...
            >
              <div className="flex items-center">
                <ChevronDown
                  className={`h-4 w-4 mr-2 transition-transform ${!expandedSections.receiving ? "-rotate-90" : ""}`}
                />
                <span className="font-medium">CeeDee Lamb Receiving Yards</span>
              </div>
            </div>
            {expandedSections.receiving && (
              <div className="p-3">
                <MarketConfidenceSelector marketId="nfl.lamb.receiving" />
              </div>
            )}
          </div>
        </div>
